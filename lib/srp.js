...
function Client(params, salt_buf, identity_buf, password_buf, secret1_buf) {
  ...
  this._private = { params: params,
                    ...
                    a_num: new BigNumber(secret1_buf),
                    u_buf: identity_buf,
                    s_buf: salt_buf };
...
function Server(params, salt_buf, identity_buf, password_buf, secret2_buf) {
  ...
  this._private = { params: params,
                    k_num: getk(params),
                    b_num: new BigNumber(secret2_buf),
                    v_num: new BigNumber(computeVerifier(params, salt_buf, identity_buf, password_buf)),
                    u_buf: identity_buf,
                    s_buf: salt_buf };
